...
/**
 * Process generate_text action for Ollama provider.
 *
...
class process_generate_text extends \core_ai\process_base
{
    ...
    public function process(): response_generate_text
    {
        ...
        // Get the prompt from action data
        $actiondata = $this->actiondata;
        $prompt = $actiondata->get_configuration('prompttext') ?? '';
        ...
        if (empty($generatedtext)) {
            return new response_generate_text(
                success: false,
                errorcode: 500,
                errormessage: 'No response from Ollama model',
            );
        }
